...
export default function AddCourseManagement({ insightTypes, token }) {
    ...
    const add = () => {
        ...
        console.log('Course Preview ' + coursePreview.name)
        console.log('Preview Thumbnail ' + thumbnail.name)
        var requestOptions = {
            method: 'POST',
            headers: myHeaders,
            body: formdata,
                                        ...
                                        <div className="py-1 sm:py-1 sm:grid sm:grid-cols-3 sm:gap-4">
                                            ...
                                            <div className="mt-1 text-xl text-gray-900 sm:mt-0 col-span-2">
                                                <div className="grid grid-cols-3 gap-3">
                                                    ...
                                                    <label htmlFor="coursepreview-file-upload" className="col-span-1 text-xl w-full relative inline-flex items-center space-x-2 px-4 py-2 border border-bcolor text-sm font-medium rounded-md text-gray-700 hover:bg-gray-50 cursor-pointer">
                                                        <span>Browse</span>
                                                        <input id="coursepreview-file-upload" name="coursepreview-file-upload" type="file" className="sr-only" onChange={(event) => {
